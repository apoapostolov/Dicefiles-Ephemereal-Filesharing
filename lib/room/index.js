...
class Room extends EventEmitter {
  ...
  get exportedRoomConfig() {
    ...
    c.push(["allowRequests", rawAllowReq !== undefined && rawAllowReq !== null ? !!rawAllowReq : CONFIG.get("allowRequests") !== false]);
    const rawLinkColl = this.config.get("linkCollection");
    c.push(["linkCollection", rawLinkColl !== undefined && rawLinkColl !== null ? !!rawLinkColl : CONFIG.get("linkCollection") !== false]);
    return c;
  }
