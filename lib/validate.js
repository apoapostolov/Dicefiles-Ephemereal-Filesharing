 ...
 *
 * All user-supplied string inputs should be validated through these helpers
 * to ensure consistent enforcement of length limits and format requirements,
 * reducing XSS/injection surface.
 */
