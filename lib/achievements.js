...
const ICONS = Object.freeze({
  files: [
    "i-file", "i-upload", "i-document", "i-images", "i-video",
    "i-audio", "i-archive", "i-list", "i-grid", "i-copy", "i-owner",
    "i-plus",
  ],
  bytes: [
    "i-upload-done", "i-download", "i-archive-b", "i-file-b", "i-document-b",
    "i-image-b", "i-video-b", "i-audio-b", "i-clock", "i-wait", "i-info",
    "i-arrow-up",
  ],
  downloads: [
    "i-download", "i-list", "i-grid", "i-file-b", "i-document-b",
    "i-images", "i-video", "i-audio", "i-archive-b", "i-info", "i-clock",
    "i-wait",
  ],
});
...
function computeAchievements(stats) {
  ...
  const allAchievements = fileAchievements.
    concat(byteAchievements, downloadAchievements);
